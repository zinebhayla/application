...
public class CategoryResourceIT {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getImg()).isEqualTo(DEFAULT_IMG);
        assertThat(testCategory.getImgContentType()).isEqualTo(DEFAULT_IMG_CONTENT_TYPE);
    }
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getImg()).isEqualTo(UPDATED_IMG);
        assertThat(testCategory.getImgContentType()).isEqualTo(UPDATED_IMG_CONTENT_TYPE);
    }
